...
class ControllerTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'knpu_lorem_ipsum.api_controller' => 'getKnpuLoremIpsum_ApiControllerService.php',
            'knpu_lorem_ipsum.knpu_ipsum' => 'getKnpuLoremIpsum_KnpuIpsumService.php',
            'knpu_lorem_ipsum.knpu_word_provider' => 'getKnpuLoremIpsum_KnpuWordProviderService.php',
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                'KnpULoremIpsumIbrahBundle' => array(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                'KnpULoremIpsumIbrahBundle' => 'KnpU\\LoremIpsumIbrahBundle\\KnpULoremIpsumIbrahBundle',
